      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="flex flex-col gap-8 text-center lg:text-left">
            ...
            <h1 className="font-black leading-tight text-balance
            ...
            <p className="text-gray-400 max-w-prose mx-auto lg:mx-0
              text-[clamp(0.95rem,2.5vw,1.05rem)]
            ">
              Crea perfiles de enlaces y menús interactivos en minutos.
              Potencia tu negocio con una presencia digital móvil que
              convierte visitantes en clientes habituales.
            </p>
